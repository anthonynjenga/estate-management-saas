...
export const SMSReminderTemplates: React.FC = () => {
  ...
  const interpolateTemplate = (content: string, u?: Unit) => {
    ...
    return content
      ...
      .replace(/{{paybill}}/g, estate.bankDetails.paybillNo || '522522')
      .replace(/{{bank_name}}/g, estate.bankDetails.bankName || 'Standard Chartered')
      .replace(/{{account_no}}/g, estate.bankDetails.accountNumber || '010283948201')
