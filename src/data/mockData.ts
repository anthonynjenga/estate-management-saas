...
export const initialEstate: Estate = {
  ...
  currency: 'KES',
  totalUnits: 48,
  managerName: 'Sarah Jenkins (Lead Property Mgr)',
  managerEmail: 'management@highviewridge.com',
  managerPhone: '+254 712 345 678',
  bankDetails: {
    bankName: 'Standard Chartered / NCBA Bank',
    accountName: 'Highview Ridge HOA Account',
    accountNumber: '010283948201',
    paybillNo: '522522 (Account: UnitNo)'
  }
};
...
export const initialUnits: Unit[] = [
  {
    ...
    ownerPhone: '+254 722 101 001',
    ownerEmail: 'a.pendelton@medclinic.org',
  ...
  },
  {
    ...
    unitNumber: 'A-102',
    block: 'Block A (Azure)',
    ownerName: 'Marcus Vance & Co.',
    ownerPhone: '+254 733 202 002',
    ownerEmail: 'marcus@vanceholdings.co.ke',
    propertyType: 'Apartment',
    sizeSqFt: 1450,
  ...
  },
  {
    ...
    unitNumber: 'A-103',
    block: 'Block A (Azure)',
    ownerName: 'Beatrice Njeri',
    ownerPhone: '+254 711 303 003',
    ownerEmail: 'beatrice.njeri@gmail.com',
  ...
  },
  {
    ...
    unitNumber: 'A-104',
    block: 'Block A (Azure)',
    ownerName: 'Captain David Omondi',
    ownerPhone: '+254 700 404 004',
    ownerEmail: 'domondi@airkenya.co.ke',
    propertyType: 'Apartment',
    sizeSqFt: 1200,
    monthlyServiceCharge: 19000,
    currentBalance: 0,
  ...
  },
  {
    ...
    ownerPhone: '+254 788 505 005',
    ownerEmail: 'elena.rostova@designhouse.io',
    propertyType: 'Duplex',
    sizeSqFt: 1800,
  ...
  },
  {
    ...
    unitNumber: 'B-202',
    block: 'Block B (Crestview)',
    ownerName: 'Joseph Kiptoo',
    ownerPhone: '+254 721 606 006',
    ownerEmail: 'jkiptoo@agrifarm.co.ke',
    propertyType: 'Apartment',
    sizeSqFt: 1200,
    monthlyServiceCharge: 19000,
    currentBalance: 0,
  ...
  },
  {
    ...
    ownerPhone: '+254 734 707 007',
    ownerEmail: 'ssmith@globalfund.org',
    propertyType: 'Apartment',
    sizeSqFt: 1350,
  ...
  },
  {
    ...
    ownerPhone: '+254 715 808 008',
    ownerEmail: 'thassan@importlogistics.com',
    propertyType: 'Duplex',
    sizeSqFt: 1850,
  ...
  },
  {
    ...
    ownerName: 'Wanjiru & Brothers Ltd',
    ownerPhone: '+254 725 909 009',
    ownerEmail: 'info@wanjirubros.co.ke',
  ...
  },
  {
    ...
    unitNumber: 'C-302',
    block: 'Block C (Horizon)',
    ownerName: 'Prof. Geoffrey Kamau',
    ownerPhone: '+254 720 111 222',
    ownerEmail: 'g.kamau@uonbi.ac.ke',
    propertyType: 'Apartment',
    sizeSqFt: 1200,
    monthlyServiceCharge: 19000,
    currentBalance: 0,
  ...
  },
  {
    ...
    ownerPhone: '+254 799 333 444',
    ownerEmail: 'c.dupont@alliancefr.or.ke',
    propertyType: 'Apartment',
    sizeSqFt: 1250,
  ...
  },
  {
    ...
    ownerName: 'Ambassador Richard Sterling',
    ownerPhone: '+254 731 555 666',
    ownerEmail: 'r.sterling@diplomatic.net',
    propertyType: 'Villa',
    sizeSqFt: 3500,
  ...
  },
  {
    ...
    unitNumber: 'V-02',
    block: 'Villa Zone (Royal Oaks)',
    ownerName: 'Chief Executive Peter Ndung\'u',
    ownerPhone: '+254 722 777 888',
    ownerEmail: 'pndungu@equitycap.co.ke',
    propertyType: 'Villa',
    sizeSqFt: 3800,
...
export const initialPayments: PaymentRecord[] = [
  ...
  },
  {
    ...
    unitId: 'u-104',
    unitNumber: 'A-104',
    residentName: 'Captain David Omondi',
    amountPaid: 19000,
  ...
  },
  {
    ...
    unitId: 'u-302',
    unitNumber: 'C-302',
    residentName: 'Prof. Geoffrey Kamau',
    amountPaid: 19000,
  ...
  },
  {
    ...
    unitId: 'u-401',
    unitNumber: 'V-01',
    residentName: 'Ambassador Richard Sterling',
    amountPaid: 47750,
    paymentDate: '2026-09-01',
    method: 'Bank Transfer',
...
export const initialExpenses: Expense[] = [
  {
    ...
    category: 'Security',
    amount: 185000,
    vendor: 'G4S Secure Solutions Ltd',
    date: '2026-09-01',
    paymentMethod: 'Bank Transfer',
    status: 'Paid',
    receiptFileName: 'G4S_Invoice_Sep2026.pdf',
  ...
  },
  {
    ...
    category: 'Utilities',
    amount: 94200,
    vendor: 'Kenya Power (KPLC)',
    date: '2026-09-03',
    paymentMethod: 'M-Pesa Paybill',
    status: 'Paid',
    receiptFileName: 'KPLC_Receipt_881920.pdf'
  },
  {
    id: 'exp-003',
  ...
  },
  {
    ...
    amount: 45000,
    vendor: 'GreenThumb Estate Services',
    date: '2026-09-05',
    paymentMethod: 'Bank Transfer',
    status: 'Approved',
  ...
  },
  {
    ...
    amount: 120000,
    vendor: 'Schindler Lifts East Africa',
    date: '2026-08-20',
    paymentMethod: 'Bank Transfer',
    status: 'Paid',
    receiptFileName: 'Schindler_Q3_Cert.pdf'
  },
  {
    id: 'exp-006',
...
export const initialBudgets: BudgetItem[] = [
  ...
  },
  {
    ...
    actualAmount: 185700,
    notes: 'KPLC lighting, borehole water pump electricity, diesel fuel.'
  },
  {
    id: 'bud-03',
    category: 'Landscaping',
